...
module.exports = {
  ...
  CAR_API: '/api/car/',
  CHAPI_MISC: '/api/chapi/',
  CHAPI_AIR_OPERATIONS: '/api/chapi-air-operations/',
  ...
  REMOTE_SERVICE_URL: 'https://mobile.dev1.southwest.com',
  ...
  CEPTOR_SITE: 'mobile.dev1.southwest.com',
  CEPTOR_ENV: 'dev',
  APP_ENV: 'dev',
