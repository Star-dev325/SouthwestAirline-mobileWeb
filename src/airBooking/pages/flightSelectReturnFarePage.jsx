...
export const FlightSelectReturnFarePage = (props: FlightSelectFarePage) => <SelectFare {...props} />;
...
export const mapStateToProps = (state: any) => ({
  ...
  ...get(state, `app.airBooking.selectedFlight.inbound`)
});
...
export default enhancers(FlightSelectReturnFarePage);
