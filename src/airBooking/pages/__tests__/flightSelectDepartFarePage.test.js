...
import { mapStateToProps } from 'src/airBooking/pages/flightSelectDepartFarePage';
...
describe('Redux Store Properties inside component props', () => {
  ...
  it('should receive selected flight from mapStatetoProps as outbound state flight', () => {
    const expectedProps = {
