...
describe('PhoneCountryCodeList', () => {
  ...
  context('normal state', () => {
    ...
    it('should show US as the first country code', () => {
      ...
      expect(USCountryCode.find('.flex10')).to.have.text('United States of America - US (+1)');
    });
    ...
    it('should show title', () => {
      ...
      expect(pageHeader).to.contain.text('Select Country Code');
    });
  });
