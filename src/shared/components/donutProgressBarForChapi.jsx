...
export class DonutProgressBar extends React.Component {
  static propTypes = {
    width: PropTypes.number,
    height: PropTypes.number,
    percentage: PropTypes.number /** [0, 100] */,
    offsetAngle: PropTypes.number /** [0, 180] */,
    strokeWidth: PropTypes.number,
    /**
     * when autoFill is set true, the Process will get the parent container size the set the width and height
     */
    autoFill: PropTypes.bool,
    animateFill: PropTypes.bool,
    strokeColor: PropTypes.oneOf(['teal', 'orange'])
  };
    ...
    return (
      ...
      >
        <svg width={size} height={size}>
          ...
          <path
            ref="fill"
            className={cx('donut-progress-bar--fill', strokeColor)}
            fill="transparent"
            strokeWidth={state.strokeWidth}
