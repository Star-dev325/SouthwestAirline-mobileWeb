...
declare module 'lodash' {
  ...
  declare class Lodash {
    ...
    slice<T>(array?: ?$ReadOnlyArray<T>, start?: ?number, end?: ?number): *;
    ...
    filter<T>(array?: ?$ReadOnlyArray<T>, predicate?: ?Predicate<T>): *;
    ...
    map<T, U>(array?: ?Array<T>, iteratee?: ?MapIterator<T, U>): *;
    map<T, U>(array: ?$ReadOnlyArray<T>, iteratee?: ReadOnlyMapIterator<T, U>): *;
    map<V, T: Object, U>(object: ?T, iteratee?: OMapIterator<V, T, U>): *;
    ...
    sortBy<T>(array: ?$ReadOnlyArray<T>, ...iteratees?: $ReadOnlyArray<Iteratee<T>>): *;
    ...
    // Mixed in
    mergeWithoutUndefined(object?: ?Object, ...sources?: Array<?Object>): Object;
    toBoolean(object: mixed, trueValues: ?mixed, falseValues: ?mixed): boolean;
    hasAll(object: mixed, keys: Array<string>): boolean;
    hasAny(object: mixed, keys: Array<string>): boolean;
    omitIfEmpty(object: mixed): mixed;
    isPromise(object: mixed): boolean;
    unflatten(object: mixed): Object;
  }
...
declare module 'lodash/fp' {
  ...
  declare class Lodash {
    ...
    sortedIndexBy<T>(
      iteratee: ValueOnlyIteratee<T>
    ): ((value: T) => (array: $ReadOnlyArray<T>) => number) & ((value: T, array: Array<T>) => number);
