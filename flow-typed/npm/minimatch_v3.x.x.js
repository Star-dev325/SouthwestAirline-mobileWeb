...
declare module 'minimatch' {
  declare class Minimatch {
    ...
    matchOne(fileArray: Array<string>, patternArray: Array<string>, partial?: boolean): boolean;
  }
  ...
  declare class MinimatchModule {
    ...
    filter(pattern: string, options?: $npm$minimatch$Options): (value: string) => boolean;

    match(list: Array<string>, pattern: string, options?: $npm$minimatch$Options): Array<string>;
  }
