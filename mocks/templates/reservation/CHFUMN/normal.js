module.exports = {
  ...
  _links: {
    retrieveForCancel: {
      href: '/v1/mobile/reservations/record-locator/RNXDDG?first-name=u&last-name=minor&action=CANCEL',
      method: 'GET'
    },
    retrieveForChange: {
      href: '/v1/mobile/reservations/record-locator/RNXDDG?first-name=u&last-name=minor&action=CHANGE',
      method: 'GET'
    },
