module.exports = {
  viewReservationViewPage: {
    ...
    shareDetails: {
      ...
      confirmationInfo: 'Confirmation #: PPUWKZ',
    ...
    _v1_infoNeededToChange: {
      href: '/v1/mobile/reservations/record-locator/PPUWKZ',
      method: 'GET',
      query: { action: 'CHANGE', 'first-name': 'AGE', 'last-name': 'SENIOR' }
    },
    ...
    _v1_infoNeededToAddCompanion: {
      href: '/v1/air-reservations/reservations/record-locator/PPUWKZ/companion-reservation/prices',
      method: 'GET',
    ...
    _links: {
      ...
      earlyBird: null,
      change: {
        href: '/v1/mobile-air-booking/page/flights/change/current/PPUWKZ',
        method: 'GET',
        query: { 'first-name': 'Age', 'last-name': 'Senior' }
      },
      cancel: {
        href: '/v1/mobile-air-booking/page/cancel-reservation/PPUWKZ',
        method: 'GET',
        query: { 'first-name': 'Age', 'last-name': 'Senior' }
      },
      ...
      addCompanion: {
        href: '/v1/mobile-air-booking/page/flights/prices/PPUWKZ/companion',
        method: 'POST',
        body: {
