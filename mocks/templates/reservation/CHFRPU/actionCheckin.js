module.exports = {
  ...
  _links: {
    retrieveForCancel: {
      href: '/v1/mobile/reservations/record-locator/CHFRPU?first-name=t&last-name=george&action=CANCEL',
      method: 'GET'
    },
    retrieveForChange: {
      href: '/v1/mobile/reservations/record-locator/CHFRPU?first-name=t&last-name=george&action=CHANGE',
      method: 'GET'
    },
