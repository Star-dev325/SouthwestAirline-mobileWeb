module.exports = {
  viewReservationViewPage: {
    ...
    _v1_infoNeededToChange: {
      href: '/v1/mobile/reservations/record-locator/CHFRPR',
      method: 'GET',
      query: {
        action: 'CHANGE',
        'first-name': 'YANG',
    ...
    _links: {
      checkInSessionToken: '...',
      change: {
        href: '/v1/mobile-air-booking/page/flights/change/current/CHFRPR',
        method: 'GET',
        query: { 'first-name': 'YANG', 'last-name': 'LU' }
      },
      cancel: {
        href: '/v1/mobile-air-booking/page/cancel-reservation/CHFRPR',
        method: 'GET',
        query: { 'first-name': 'YANG', 'last-name': 'LU' }
      },
      checkIn: null,
