module.exports = {
  viewReservationViewPage: {
    ...
    _v1_infoNeededToChange: {
      href: '/v1/mobile/reservations/record-locator/CHFRPD',
      method: 'GET',
      query: {
        action: 'CHANGE',
        'first-name': 'YANG',
    ...
    _links: {
      checkInSessionToken: '...',
      change: {
        href: '/v1/mobile-air-booking/page/flights/change/current/CHFRPD',
        method: 'GET',
        query: { 'first-name': 'YANG', 'last-name': 'LU' }
      },
      cancel: {
        href: '/v1/mobile-air-booking/page/cancel-reservation/CHFRPD',
        method: 'GET',
        query: { 'first-name': 'YANG', 'last-name': 'LU' }
      },
      checkIn: null,
