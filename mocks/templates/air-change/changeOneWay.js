module.exports = {
  viewReservationViewPage: {
    ...
    _v1_infoNeededToChange: {
      href: '/v1/mobile/reservations/record-locator/CHGONE',
      method: 'GET',
    ...
    _links: {
      ...
      change: {
        href: '/v1/mobile-air-booking/page/flights/change/current/CHGONE',
        method: 'GET',
        query: { 'first-name': 'Test', 'last-name': 'Wang' }
      },
      cancel: {
        href: '/v1/mobile-air-booking/page/cancel-reservation/CHGONE',
        method: 'GET',
        query: { 'first-name': 'Test', 'last-name': 'Wang' }
      },
