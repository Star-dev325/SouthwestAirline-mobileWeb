module.exports = {
  viewReservationViewPage: {
    ...
    shareDetails: {
      ...
      confirmationInfo: 'Confirmation #: REACMB',
    ...
    _links: {
      ...
      earlyBird: {
        href: '/v1/mobile-air-booking/page/early-bird/REACMB',
        method: 'GET',
        query: {
          'first-name': 'Tessa',
          'last-name': 'Test'
      ...
      change: null,
      reaccom: {
        href: '/v1/mobile-air-booking/page/flights/reaccom/reservations/current/REACMB',
        method: 'GET',
        query: {
          'first-name': 'Tessa',
          'last-name': 'Test'
      ...
      cancel: {
        href: '/v1/mobile-air-booking/page/cancel-reservation/REACMB',
        method: 'GET',
        query: {
          'first-name': 'Tessa',
          'last-name': 'Test'
      ...
      checkIn: null,
      contactInformation: {
        href: '/v1/mobile-air-booking/page/view-reservation/contact-info/REACMB',
        method: 'GET',
        query: {
      ...
      editPNRPassengers: [
        {
          href: '/v1/mobile-air-booking/page/view-reservation/edit-pnr-passenger/REACMB',
          method: 'GET',
          query: {
            'first-name': 'Tessa',
            'last-name': 'Test',
