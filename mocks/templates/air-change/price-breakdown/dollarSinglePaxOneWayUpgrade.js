module.exports = {
  changePricingPage: {
    ...
    fareSummary: {
      ...
      newAmountDue: {
        item: 'Amount due',
        fare: { amount: '70.00', currencyCode: 'USD', currencySymbol: '$' },
        tax: null
      },
    ...
    _meta: { purchaseWithPoints: false, newCardHasSufficientFunds: false, isInternational: false, isUpgrade: false },
    _links: {
