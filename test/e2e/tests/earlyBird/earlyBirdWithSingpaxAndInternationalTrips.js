...
module.exports = {
  ...
  'Verify details page'() {
    detail
      ...
      .assert.containsText('@destinationCity', 'Cancun')
      .assert.containsText('@totalPrice', '50.00')
      .expect.element('@loginButton').text.to.not.contain('Enroll');
  },
  ...
  'Verified confirmation page'(client) {
    earlyBirdConfirmation
      ...
      .assert.urlEquals(`${client.launch_url}/earlybird/checkin/KTZM9Q/confirmation`)
      .assert.containsText('@confirmationText', 'EarlyBird Check-In® added for the following flights and passengers.')
      .assert.containsText('@confirmationNumber', 'KTZM9Q')
      ...
      .assert.containsText('@amountApplied', '50.00')
      .assert.containsText('@billingAddress', '893 Main St\nBrooklyn, NY US 24266')
